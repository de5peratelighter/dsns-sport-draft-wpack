...
import { TABLE_START_PROTOCOL_RETRACTABLE_RESULTS } from "./tables/START_PROTOCOL_RETRACTABLE";
import { TABLE_START_PROTOCOL_COMBAT_RESULTS } from "./tables/START_PROTOCOL_COMBAT";
import { START_PROTOCOL_RELAY_RESULTS } from "./tables/START_PROTOCOL_RELAY"
...
const GIVE_TABLE_BY_TYPE = (type, tables) => {
  switch (type) {
    ...
    case "START_PROTOCOL_RETRACTABLE":
      return TABLE_START_PROTOCOL_RETRACTABLE_RESULTS(tables);
    case "START_PROTOCOL_COMBAT":
      return TABLE_START_PROTOCOL_COMBAT_RESULTS(tables);
    case "START_PROTOCOL_RELAY":
      return START_PROTOCOL_RELAY_RESULTS(tables);
    case "TEAM_RESULTS":
